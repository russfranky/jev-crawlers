...
const PREFIX_RE = /\b((?:sk_live_|sk_test_|rk_live_|rk_test_|sk-live-|sk-test-|sk-proj-|ghp_|gho_|ghu_|ghs_|ghr_|github_pat_|xox[baprs]-|AKIA|ASIA|AIza)[A-Za-z0-9_\-]{8,})/g;
